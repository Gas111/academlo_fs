  ...
  return (
    <div className="product-info">
      ...
      <section className="product-info__image">
        ...
        <div><button onClick={handleBackImage} className='button-back'>&#60;</button></div>
        <div className='image-container'><img src={product?.productImgs[index]} alt="image of product" id="image"/></div>
        <div><button onClick={handleNextImage} className='button-foward'>&#62;</button></div>
      </section>
